      ...
      <Card className={classes.card}>
        ...
        <CardContent>
          ...
          <Typography component="p">
            ...
            You may need to copy it some place easier to upload... Open terminal
            and type `ghdid exportWebWallet ~/Desktop/web.wallet.enc` <br />
            You will need to unlock it before it can be used. <br />
            The password is the same one used when you created your DID with the
            `init` command..
          </Typography>
        </CardContent>
